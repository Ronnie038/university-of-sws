...
academicDepartmentSchema.pre('findOneAndUpdate', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const isDepartmentExist = yield AcademicDepartment.findById(query._id);
        if (!isDepartmentExist) {
            throw new AppError_1.AppError(http_status_1.default.NOT_FOUND, 'The department does not exist ');
        }
        next();
    });
});
